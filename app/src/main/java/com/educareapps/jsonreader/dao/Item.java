...
public class Item {
    ...
    public Item(Long id, Float x, Float y, Integer rotation, Long key, Integer isCircleView, Integer circleColor, String userText, Integer textColor, Integer textSize, Integer borderColor, Integer backgroundColor, Integer drawable, Float width, Float height, Float left, Float right, Float top, Float bottom, String imagePath, String type, java.util.Date createdAt, java.util.Date updatedAt, Long task, String itemSound, String result, String openApp, String openUrl, int allowDragDrop, long dragDropTarget, int cornerRound, long navigateTo, long showedBy, long hideBy, int closeApp, int fontTypeFace, int fontAlign, int autoPlay, int soundDelay, int borderPixel, String showedByTarget, String hiddenByTarget, int helper, int tutorialAnimation, int tutorialX, int tutorialY, long tutorialTag, String showedMiniFeedBack, String hideMiniFeedback, Integer extraOne, Integer extraTwo, String extraThree, String extraFour, Integer extraFive, long taskId) {
        ...
        this.showedMiniFeedBack = showedMiniFeedBack;
        this.hideMiniFeedback = hideMiniFeedback;
    ...
    /** Not-null value. */
    public String getShowedMiniFeedBack() {
        return showedMiniFeedBack;
    }

    /** Not-null value; ensure this value is available before it is saved to the database. */
    public void setShowedMiniFeedBack(String showedMiniFeedBack) {
        this.showedMiniFeedBack = showedMiniFeedBack;
    }

    /** Not-null value. */
    public String getHideMiniFeedback() {
        return hideMiniFeedback;
    }

    /** Not-null value; ensure this value is available before it is saved to the database. */
    public void setHideMiniFeedback(String hideMiniFeedback) {
        this.hideMiniFeedback = hideMiniFeedback;
    }

    public Integer getExtraOne() {
        return extraOne;
    }

    public void setExtraOne(Integer extraOne) {
        this.extraOne = extraOne;
    }

    public Integer getExtraTwo() {
        return extraTwo;
    }

    public void setExtraTwo(Integer extraTwo) {
        this.extraTwo = extraTwo;
    }
    ...
    public Integer getExtraFive() {
        return extraFive;
    }

    public void setExtraFive(Integer extraFive) {
        this.extraFive = extraFive;
    }
