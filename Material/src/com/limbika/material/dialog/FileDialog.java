...
public class FileDialog extends SelectorDialog {
    ...
    private String globalPath = "";/// added by sumon
    TextView pathView; ///added by sumon
        ...
        grid.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                if (file.isDirectory()) {
                    ...
                    mSelectedFile = null;
                    pathView.setText(file.getAbsolutePath());
                    if (mStrategy == Strategy.FILE && Build.VERSION.SDK_INT > 10)
                        grid.clearChoices();
                } else {
                    mSelectedFile = file;
    ...
    public void setPath(File path) {
        ...
        this.globalPath = path.getAbsolutePath();
        /// added by sumon
        if (globalPath != "" && globalPath != null) {
            pathView.setText(globalPath);
        }
